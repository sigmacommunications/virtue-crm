            ...
            <form id="payment-form" action="{{ route("payment.stripe") }}" method="POST">
               @csrf
                ...
                <div class="form-group">
                    ...
                    <input id="NameOnCard" class="form-control" name="Cardholder" type="text" maxlength="255"/>
                </div>
                <div class="form-group">
                    <input type="hidden" value="{{$invoice->id}}" name="invoice_id"/>
                    <input type="hidden" name="token"/>
                    <label for="CreditCardNumber">Card number</label>
                    <div id="CreditCardNumber" class=" border ps-2 pl-2" type="text"></div>
                </div>
                <div class="expiry-date-group form-group">
                    <label for="ExpiryDate">Expiry date</label>
                    <div id="ExpiryDate" class=" border ps-2 pl-2"></div>
                </div>
                <div class="security-code-group form-group">
                    <label for="SecurityCode">Security code</label>
                    <div class="input-container">
                        <div id="SecurityCode" class=" border ps-2 pl-2"></div>
                ...
                <div class="zip-code-group form-group">
                    ...
                    <div class="input-container">
                    <input id="ZIPCode" class="border form-control" name="zipcode" type="text" maxlength="10"/>
                        <a tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-placement="left" data-content="Enter the ZIP/Postal code for your credit card billing address."><i class="fa fa-question-circle"></i></a>
                    </div>
                </div>
                <div id="errormessage" class="text-danger" role="alert"></div> <!-- Error message element -->
                <button id="PayButton" class="btn btn-block btn-success submit-button" type="submit">
                    <span class="submit-button-lock"></span>
                    <span class="align-middle">Pay ${{ $invoice->total_amount }}</span>
                </button>
            </form>
        </div>
    </div>
...
<script>
    ...
    cardNumberElement.mount('#CreditCardNumber');
