                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        ...
                        <form name="formEdit" id="formEdit" method="POST"
                            action="{{ route('setup-pm.update', ['setup_pm' => $paymentMethod->id]) }}"
                            ...
                            <div class=" box-primary">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group {{ $errors->has('title') ? 'has-error' : null }}">
                                            ...
                                            <input type="text" name="title" class="form-control" id="title"
                                                placeholder="Title" value="{{ old('title', $paymentMethod->title) }}">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group my-2">
                                            ...
                                            <select id="paymentMethod" name="paymentMethod" class="form-control" required>
                                                ...
                                                <option value="paypal"
                                                    {{ old('paymentMethod', $paymentMethod->mechant_company) == 'PayPal' ? 'selected' : '' }}>
                                                    PayPal</option>
                                                <option value="stripe"
                                                    {{ old('paymentMethod', $paymentMethod->mechant_company) == 'Stripe' ? 'selected' : '' }}>
                                                    Stripe</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group {{ $errors->has('paypalClientId') ? 'has-error' : null }}">
                                            ...
                                            <input type="text" name="paypalClientId" class="form-control"
                                                ...
                                                value="{{ old('paypalClientId', $paymentMethod->client_id) }}">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group {{ $errors->has('paypalSecret') ? 'has-error' : null }}">
                                            ...
                                            <input type="password" name="paypalSecret" class="form-control"
                                                ...
                                                value="{{ old('paypalSecret', $paymentMethod->secret_key) }}">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group {{ $errors->has('stripePublicKey') ? 'has-error' : null }}">
                                            ...
                                            <input type="text" name="stripePublicKey" class="form-control"
                                                ...
                                                value="{{ old('stripePublicKey', $paymentMethod->public_key) }}">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group {{ $errors->has('stripeSecretKey') ? 'has-error' : null }}">
                                            ...
                                            <input type="password" name="stripeSecretKey" class="form-control"
                                                ...
                                                value="{{ old('stripeSecretKey', $paymentMethod->secret_key) }}">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="company_id[]" multiple class="js-example-basic-multiple w-100" required>
                                            @foreach ($companies as $comp)
                                                <option value="{{ $comp->id }}" {{ (in_array($comp->id ,  $paymentMethod->MethodCompanies->pluck("company_id")->toArray())) ? 'selected' : ''   }}  >{{ $comp->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
